...
public class GUI extends JFrame{
	...
	public GUI() {
		...
		JMenuItem deleteCurrent = new JMenuItem("Delete current row");
		options.add(deleteCurrent);
	...
	public void addActivity()
	{
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				model.addRow(new Object[] { name, (String)stagesBox.getSelectedItem(), agenda.getActivity().get(counter).getStartTime(), agenda.getActivity().get(counter).getEndTime(), agenda.getActivity().get(counter).getPopularity()});
	...
	public void fillTable()
	{
		...
		{
			model.addRow(new Object[] {a.getName(), a.getStage().getStage(), a.getStartTime(), a.getEndTime(), a.getPopularity()});
	...
	public void changeActivity(int index){
		...
		activityBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				stageBox.setSelectedItem(agenda.getActivity().get(activityBox.getSelectedIndex()).getStage().getStage());
		...
		changeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(Integer.parseInt(popularityField.getText()) < 0 || Integer.parseInt(popularityField.getText()) > 10)
				{
					JOptionPane.showMessageDialog(GUI.this, "M8, u fucked up");
					return;							
				}
				
				agenda.getActivity().get(activityBox.getSelectedIndex()).setPopularity(Integer.parseInt(popularityField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).getStage().setStage(stageBox.getSelectedItem().toString());
				agenda.getActivity().get(activityBox.getSelectedIndex()).setStartHour(Integer.parseInt(beginHourField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).setStartMin(Integer.parseInt(beginMinField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).setEndHour(Integer.parseInt(endHourField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).setEndMin(Integer.parseInt(endMinField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).setStartTime(Integer.parseInt(beginHourField.getText()), Integer.parseInt(beginMinField.getText()));
				agenda.getActivity().get(activityBox.getSelectedIndex()).setEndTime(Integer.parseInt(endHourField.getText()), Integer.parseInt(endMinField.getText()));
//				model.removeRow(row);
				
				model.addRow(new Object[] { agenda.getActivity().get(activityBox.getSelectedIndex()).getName(), agenda.getActivity().get(activityBox.getSelectedIndex()).getStage().getStage(), agenda.getActivity().get(activityBox.getSelectedIndex()).getStartTime(), agenda.getActivity().get(activityBox.getSelectedIndex()).getEndTime(), agenda.getActivity().get(activityBox.getSelectedIndex()).getPopularity()});
